# Player Pro Micro-Modular Context Prompt

Build/improve Player Pro, a Kotlin Android video-only headunit player. Keep it video focused. The only audio feature is Play as Music from the currently playing video.
